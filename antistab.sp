...
{
	sm_antistab_damage = CreateConVar("sm_antistab_damage", "55.0", "The damage limit for all stabs.");
	sm_antistab_timer = CreateConVar("sm_antistab_timer", "5.0", "The length of knife immunity after getting stabbed.");
