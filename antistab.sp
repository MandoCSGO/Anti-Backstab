...
public void OnPluginStart()
{
	...
	antistab_color_alpha = GetConVarInt(sm_antistab_color_alpha);
...
public Action OnTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype)
{
    ...
    if (damage > antistab_damage)
    {
        ...
        if (StrContains(weapon, "knife"))
        {
            ...
            SetEntityRenderColor(victim, antistab_color_red, antistab_color_green, antistab_color_blue, antistab_color_alpha);
